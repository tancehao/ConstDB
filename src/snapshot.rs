...
impl<W: Write> SnapshotWriter<W> {
    ...
    pub fn write_u64(&mut self, n: u64) -> std::io::Result<&mut Self> {
        let a = n.to_le_bytes();
        self.write_bytes(a.as_slice())
    }
    ...
    T: tokio::io::AsyncRead + std::marker::Unpin,
{
    ...
    pub async fn read_u64(&mut self) -> Result<u64, CstError> {
        let d = self.read_bytes(8).await?;
